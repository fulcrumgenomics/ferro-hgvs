...
//! the restated-number shape `docs/TESTING.md` ("Writing a test") warns about: a
//! derived figure quoted against a base nobody restates. Quote the deltas, which survived the rebase
