...
///
/// `spdi::splice_denoted_sequence`'s doc comment records this as a 233-fire false-positive
/// class of the denoted-sequence oracle (#1749). The cause was that `spdi::apply::triples_are_disjoint`
